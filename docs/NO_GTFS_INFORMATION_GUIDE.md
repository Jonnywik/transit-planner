...
| MRT-3 station route and fare | Published station order and fare-matrix lookup | Rider-selected MRT-3 stations and official regular or concessionary matrix | `MRT3_STATION_REFERENCE_READY` | Location access, transfers, another rail/road mode, a current-fare guarantee, eligibility confirmation, timetable, arrival, or live status |
