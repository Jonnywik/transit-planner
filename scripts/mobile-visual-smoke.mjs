...
try {
  ...
  const requiredShell = ['id="search-panel"', 'class="sheet-handle"', 'id="route-form"', 'id="btn-search"', 'id="results-panel"'];
  ...
  const requiredMobileRules = ['@media (min-width: 720px)', '.search-panel { position: absolute', 'bottom: 0;', '.results-panel { position: absolute'];
